...
class MLP_Classifier_Twolang(nn.Module):

    def __init__(self, embedding_dim, vocab_size_en, vocab_size_zh, target_size=3, seq_length=50):
        super(MLP_Classifier_Twolang, self).__init__()
        self.embedding_dim = embedding_dim
        ...
        #self.fc2 = nn.Linear(embedding_dim*4, target_size)
...
class Text_CNN_Classifier(nn.Module):
    ...
    def __init__(self, embedding_dim, vocab_size, target_size=3, seq_length=50):
        ...
        self.conv3_1 = nn.Conv2d(1, 3, (3, embedding_dim))
        self.conv4_1 = nn.Conv2d(1, 3, (4, embedding_dim))
